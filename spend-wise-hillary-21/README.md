...
Deploy the folder to Netlify or open `index.html` locally. On Android use Chrome install/add to home screen. On iPhone use Safari Share > Add to Home Screen. On laptops use the browser install icon in Chrome or Edge.
